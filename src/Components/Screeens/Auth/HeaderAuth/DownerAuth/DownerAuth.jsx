import styles from "./DownerAuth.module.css"
        ...
        <div className={ styles.wrapper }>
            <div className={ styles.navigate }>
                ...
                <ul className={ styles.list }>
                    <li><Link className={ activeFav ? styles.link  : [styles.link, styles.active].join(" ") } to="/auth">Каталог</Link></li>
                    ...
                    <div className={ styles.blockLink }>
                        <li><Link className={  activeFav ? [styles.link, styles.active].join(" ") : styles.link } to="/favorites">Мое избранное</Link></li>
