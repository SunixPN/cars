...
const Head = ({ buttonsState, setButtonState }) => {
    ...
    <div className={ styles.head }>
        <div className={ styles.box }>
            <div className={ styles.buttons }>
                <button onClick={() => {setButtonState({all: true, eu: false, us: false, cath: false})}} className={ buttonsState.all ? styles.buttonActive : styles.button }>Все</button>
                <button onClick={() => {setButtonState({all: false, eu: true, us: false, cath: false})}} className={ buttonsState.eu ? styles.buttonActive : styles.button }>Оформление</button>
                <button onClick={() => {setButtonState({all: false, eu: false, us: true, cath: false})}} className={ buttonsState.us ? styles.buttonActive : styles.button }>Готовиться к выдаче</button>
                <button onClick={() => {setButtonState({all: false, eu: false, us: false, cath: true})}} className={ buttonsState.cath ? styles.buttonActive : styles.button }>Можно забрать</button>
            </div>
