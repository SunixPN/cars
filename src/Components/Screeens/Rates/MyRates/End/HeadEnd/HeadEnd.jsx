import styles from "./HeadEnd.module.css"
import { useState } from "react"

const HeadEnd = ({ buttonsState, setButtonState }) => {
    ...
    <div className={ styles.head }>
        <div className={ styles.box }>
            <div className={ styles.buttons }>
                ...
                <button onClick={() => {setButtonState({all: false, eu: true, us: false})}} className={ buttonsState.eu ? styles.buttonActive : styles.button }>Winning</button>
                <button onClick={() => {setButtonState({all: false, eu: false, us: true})}} className={ buttonsState.us ? styles.buttonActive : styles.button }>OutBid</button>
            </div>
