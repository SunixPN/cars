    ...
    <div className={ styles.head }>
        ...
        <div className={ styles.box }>
            <div className={ styles.buttons }>
                ...
                <button onClick={() => {setButtonState({all: false, eu: true, us: false})}} className={ buttonsState.eu ? styles.buttonActive : styles.button }>Европа</button>
                <button onClick={() => {setButtonState({all: false, eu: false, us: true})}} className={ buttonsState.us ? styles.buttonActive : styles.button }>США</button>
            </div>
            <div className={ styles.filters }>
                ...
                <Select text={ "Сначала ближайшие" } list={["Значение 1", "Значение 2", "Значение 3"]} />
            </div>
        </div>
				<p className={ styles.searching }><span className={ styles.fade }>Найдено</span> 120 результатов</p>
    </div>
  )
}
