import styles from "./HeadLots.module.css"
    ...
    <div className={ styles.head }>
        <div className={ styles.box }>
            <div className={ styles.buttons }>
                ...
                <button onClick={() => {setButtonState({all: false, eu: true, us: false})}} className={ buttonsState.eu ? styles.buttonActive : styles.button }>На модерации</button>
                <button onClick={() => {setButtonState({all: false, eu: false, us: true})}} className={ buttonsState.us ? styles.buttonActive : styles.button }>Активные лоты</button>
            </div>
